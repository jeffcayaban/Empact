...
import PetitionDisagree from "../PetitionDisagree";

describe('PetitionDisagree', () => {

    it('should render a loader', () => {
        const component = shallow(
            <PetitionDisagree match={{ params: { id: 'testId' } }} />
        );
    ...
    it('should render a content retrieval alert', () => {
        const component = shallow(<PetitionDisagree match={{ params: { id: 'testId' } }} />);
